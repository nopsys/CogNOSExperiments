...
if (Sys.getenv("RSTUDIO") == "1") { 
  ...
  setwd("/Users/guidochari/Documents/Projects/Research/Nopsys/CogNOSExperiments/Report/BasePerformance")
...
@
<<LanguagesPerformance, child='BasePerformance/overview.Rnw', results='asis'>>=
